...
> jobs
# 启动情况如下 
[1]   Running                 cd .. && bin/zookeeper-server-start.sh config/zookeeper.properties &  (wd: /usr/changning/kafka_2.11-0.11.0.1/config)
...
> bin/kafka-topics.sh --create --bootstrap-server 10.4.121.218:9093,10.4.121.218:9094 --replication-factor 3 --partitions 1 --topic my-replicated-topic
